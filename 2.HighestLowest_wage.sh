# Returns to sd out: gender, yearsExpe- rience, and wage for the 
# highest earner and lowest earner, number of females in top 10
# note, for head command check if -n1 gives you column name 
